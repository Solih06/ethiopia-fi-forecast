...
def enrich_ethiopia_dataset():
    ...
    try:
        ...
        print(
            "Starter dataset missing. Creating a mock skeleton baseline for schema verification..."
        )
    ...
    enriched_records = [
        # Task 1: Add Disaggregated Findex Observations (Gender Gaps)
        {
            ...
            "confidence": "high",
            "collected_by": "Soliana Hailekiros",
        ...
        },
        {
            "record_type": "observation",
            "pillar": "access",
            "indicator": "Account Ownership: Male (% age 15+)",
        ...
        # Task 1: Add Supply-Side Enabler Infrastructure Observations
        {
            ...
            "indicator": "Active Mobile Money Agents per 100k Adults",
            "indicator_code": "INF_AGNT_DENS",
            "value_numeric": 245.8,
        ...
        # Task 1: Add Regulatory/Policy Events (Leave Pillar empty per requirements!)
        {
            "record_type": "event",
            "category": "policy",
            "indicator": "National Financial Inclusion Strategy II (NFIS-II) Launch",
            "indicator_code": "EVT_NFIS_II",
        ...
        # Task 1: Add Impact Links capturing cross-border/historical evidence
        {
            ...
            "parent_id": "EVT_NFIS_II",
            "pillar": "access",
            "related_indicator": "ACC_OWNERSHIP",
            "impact_direction": "positive",
            "impact_magnitude": "medium",
            "lag_months": 12,
            "evidence_basis": "Comparable Country Evidence (FSD Kenya macro models)",
